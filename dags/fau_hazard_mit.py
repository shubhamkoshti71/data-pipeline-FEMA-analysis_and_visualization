...
def fema_haz_mit():
    ...
    def fetch():
        ...
        while True:
            ...
            if 'HazardMitigationAssistanceProjects' not in data:
                print("Error: The expected data structure was not found.")
                break

            # Accumulating records
            records = data['HazardMitigationAssistanceProjects']
    ...
    def upload(records):
        ...
        snapshot_name = f"hazard_mitigation_{data_hash}.json"
...
fema_hazard_mitigation_dag = fema_haz_mit()